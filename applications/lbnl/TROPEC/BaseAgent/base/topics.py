...
ENERGY_PRICE_FROM_ENERGY_PRODUCER_TOPIC = "{base}/energy_price_from_producer".format(base = TROPEC_BASE)
...
FINISHED_PROCESSING_MESSSAGE = "{base}/finished_processing".format(base = TROPEC_BASE)
...
CHANGE_DEVICE_PARAMETER_TOPIC = "{base}/prameter_change".format(base = TROPEC_BASE)
CHANGE_DEVICE_PARAMETER_TOPIC_SPECIFIC_AGENT = CHANGE_DEVICE_PARAMETER_TOPIC + "/{id}"

TERMINATE_TOPIC = "{base}/terminate".format(base = TROPEC_BASE)

ENERGY_PRICE_FROM_INTERNET_TOPIC = "{base}/CBERD_internet_energy_price".format(base = TROPEC_BASE)