...
class TROPEC_BaseAgent(Agent):
    """
    Base class for TROPEC agents.  Responsible for most of the general things need to run in volttron
    ...
    def default_headers(self, target_device):
        """
        The default headers in a TROPEC message.  
...
def main(argv=sys.argv):
    ...
    utils.vip_main(TROPEC_BaseAgent)
